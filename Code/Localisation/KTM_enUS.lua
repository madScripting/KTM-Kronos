...
klhtm.string.data["enUS"] = 
{
	...
	["spell"] = 
	{
		...
		immolate = "Immolate",
		shadowofebonroc = "Shadow of Ebonroc",
	...
	["boss"] = 
	{
		["speech"] = 
		{
			...
			["onyxiaengage"] = "Usually, I must leave my lair to feed",
			...
			["broodlordengage"] = "None of your kind should be here! You've doomed only yourselves!",
			["jeklikengage"] = "Lord Hir'eek, grant me wings of vengance!",
			["jindoengage"] = "Welcome to da great show friends! Step right up to die!",
			["arlokkengage"] = "Bethekk, your priestess calls upon your might!",
			["mandokirengage"] = "I'll feed your souls to Hakkar himself!",
			["marliengage"] = "Aid me my brood!",
			["hakkarengage"] = "PRIDE HERALDS THE END OF YOUR WORLD. COME, MORTALS! FACE THE WRATH OF THE SOULFLAYER!",
			["viscidusexplodes"] = "Viscidus explodes!",
			["sarturaengage"] = "You will be judged for defiling these sacred grounds! The laws of the Ancients will not be challenged! Trespassers will be annihilated!",
		},
