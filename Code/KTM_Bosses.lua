...
me.onevent = function()
	if event == "CHAT_MSG_MONSTER_EMOTE" then
		...
		-- Viscidus explodes
		if string.find(arg1, mod.string.get("boss", "speech", "viscidusexplodes")) then
			
			-- reset threat on explosion so it's at 0 when he reforms
			mod.table.resetraidthreat()
	...
	elseif event == "CHAT_MSG_MONSTER_YELL" then
		...
		-- Sartura pull
		if string.find(arg1, mod.string.get("boss", "speech", "sarturaengage")) then
			
			-- reset threat on pull, in case something was aggrod
			mod.table.resetraidthreat()
		...
		-- Broodlord pull
		if string.find(arg1, mod.string.get("boss", "speech", "broodlordengage")) then
			
			-- reset threat on pull, in case whelps were aggrod
			mod.table.resetraidthreat()
		...
		-- Ony pull
		if string.find(arg1, mod.string.get("boss", "speech", "onyxiaengage")) then
			
			-- reset threat on pull
			mod.table.resetraidthreat()
		...
		-- ZG jindo boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "jindoengage")) then
		...
		-- ZG panther boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "arlokkengage")) then
		...
		-- ZG raptor boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "mandokirengage")) then
		...
		-- ZG spider boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "marliengage")) then
		...
		-- ZG hakkar boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "hakkarengage")) then
		...
		-- ZG bat boss engage
		if string.find(arg1, mod.string.get("boss", "speech", "jeklikengage")) then
